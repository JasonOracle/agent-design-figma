...
- `references/lessons.md` — **48 empirically measured invariants** (protocol / Plugin API / data flow / testing / Windows environment / collaboration; marks which are guarded by tools and which rely purely on discipline)
